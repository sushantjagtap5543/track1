...
import org.traccar.handler.AttributeComputationProvider;
...
public class AttributeResource extends ExtendedObjectResource<Attribute> {
    ...
    @Inject
    private AttributeComputationProvider attributeComputationProvider;
    ...
    public Response test(@QueryParam("deviceId") long deviceId, Attribute entity) throws Exception {
        ...
        try {
            ...
            Object result = attributeComputationProvider.computeAttribute(entity, position);
            if (result != null) {
