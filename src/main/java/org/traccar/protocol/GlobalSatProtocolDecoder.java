...
public class GlobalSatProtocolDecoder extends BaseProtocolDecoder {
    ...
    @Override
    protected void init() {
        format0 = getConfig().getString(Keys.PROTOCOL_FORMAT0.withPrefix(getProtocolName()), "TSPRXAB27GHKLMnaicz*U!");
        format1 = getConfig().getString(Keys.PROTOCOL_FORMAT1.withPrefix(getProtocolName()), "SARY*U!");
    }
